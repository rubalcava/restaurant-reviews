            ...
            success: function(response) {
                Promise.resolve(response).then(function(the_response) {
                    ...
                    for (var object_index in the_response.response.hours.timeframes) {
                        ...
                        self.data_for_hours.push({
                            days: thing_to_search_in[object_index].days,
                            hours: thing_to_search_in[object_index].open
                        });
                    }
                    ...
                    if (self.data_for_hours.length === 0) {
                        self.data_for_hours.push({
                            days: ['No  operating hours found'],
                            hours: [{
                                start: 'No opening time found',
                                end: 'No closing time found'
                            }]
                        });
                    }
